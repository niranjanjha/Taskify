...
import { CheckCircle, Calendar, Users, Bell, List, FileText, Clock, Flag, Zap } from 'lucide-react';

const CSSLoaders = () => {
  // Icons related to task management with enhanced animations
  const taskIcons = [
    ...
    <div className="page">
      <style jsx>{`
        .loader {
          ...
          --light-color: rgba(192, 132, 252, 0.3); /* Purple light color */
          --dot-size: 5px;
      ...
      <main className="container">
        {taskIcons.map((item, index) => {
          ...
          // Assign different animations to different icons
          const animations = ['float', 'spin', 'pulse', 'ring', 'bounce', 'swing'];
          const animationClass = animations[index % animations.length];
          
          return (
            <div key={index} className="item">
              <Icon 
                className={`w-8 h-8 text-purple-500 ${animationClass}`} 
                style={{ 
