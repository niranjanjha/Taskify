...
const FaceLogin = ({ onSubmit, onSwitchMode, onSwitchToEmail }) => {
  ...
  useEffect(() => {
    console.log("FaceLogin component mounted");
    ...
    // Cleanup function
    return () => {
      console.log("FaceLogin component unmounting, cleaning up streams");
  ...
  const captureAndLogin = async () => {
    console.log("captureAndLogin called");
    ...
    try {
      ...
      console.log("Face detected, proceeding with authentication...");
