...
import { LogOut, Settings, Zap, ChevronDown } from 'lucide-react'
      ...
      <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div ref={menuref} className='relative'>
            ...
            {menuOpen && (
              <ul className='absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-purple-150 z-50 overflow-hidden animate-fadeIn'>
                <li className='p-2'>
                  <button
                    onClick={() => {
                      setMenuOpen(false)
