import {
    ...
    Clock,
    Calendar,
    Leaf, // Added for Zen Space
    TrendingUp, // Added for Analytics
    Users, // Added for Collaborated Tasks
    Video, // Added for Connect feature
    ClipboardList, // Added for To Do feature
    MessageSquare, // Added for Meetings page
} from "lucide-react"
...
export const priorityStyles = {
    ...
    Medium: "bg-yellow-custom text-yellow-custom border-yellow-custom",
...
export const menuItems = [
    ...
    { text: "Meetings", path: "/meetings", icon: <MessageSquare className="w-5 h-5" /> },
    ...
    { text: "Collaborated Tasks", path: "/collaborated", icon: <Users className="w-5 h-5" /> }, // Added Collaborated Tasks
    { text: "Connect", path: "/connect", icon: <Video className="w-5 h-5" /> }, // Added Connect feature
    { text: "Analytics", path: "/analytics", icon: <TrendingUp className="w-5 h-5" /> }, // Added Analytics
    { text: "To Do", path: "/todo", icon: <ClipboardList className="w-5 h-5" /> }, // Added To Do feature
    { text: "Zen Space", path: "/zen", icon: <Leaf className="w-5 h-5" /> }, // Zen Space
]
...
export const getPriorityColor = (priority) => {
    const colors = {
        ...
        medium: "border-yellow-custom bg-yellow-50/50 text-yellow-custom",
...
export const getPriorityBadgeColor = (priority) => {
    const colors = {
        ...
        medium: "bg-yellow-custom text-yellow-custom",
...
export const STATS = [
    ...
    { key: "mediumPriority", label: "Medium Priority", icon: Flame, iconColor: "bg-yellow-custom text-yellow-custom", borderColor: "border-purple-100", valueKey: "mediumPriority", textColor: "text-yellow-custom" },
...
export const CT_CLASSES = {
    ...
    btnBase: "px-2 py-1 md:px-3 md:py-1.5 rounded-lg text-xs font-medium transition-all duration-200 flex items-center gap-1.5",
